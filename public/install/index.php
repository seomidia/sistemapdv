...
<html lang="en">
  <head>
    ...
    <title>Fazendo uma verificação de pré-instalação ...</title>
  ...
  <body>
  	<div class="container">
		...
		<center>
			<h2>Fazendo uma verificação de pré-instalação ...</h2><br/>
		</center>
	...
	<center>
		...
		<p>
			<?php
				if($all_ok){
					echo "<span class='text-success'>Todas as configurações parecem corretas. Vamos para <a href=$install_link>Próxima Etapa</a></span>";
				} else {
